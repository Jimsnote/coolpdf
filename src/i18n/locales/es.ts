export const es = {
  ...
  tools: {
    'ocr-pdf': {
      name: 'OCR PDF',
      description: 'Haz que tus PDF escaneados sean buscables con OCR, en tu propio dispositivo.',
    },
    'qr-code': {
      name: 'Generador de códigos QR',
      description: 'Crea códigos QR para enlaces, texto y más, generados localmente.',
    },
    'merge-pdf': {
      name: 'Unir PDF',
    ...
    'docx-to-markdown': {
      ...
      description: 'Convierte un documento Word en Markdown limpio, listo para IA.',
    },
    'xlsx-to-markdown': {
    ...
    'heic-to-pdf': {
      name: 'HEIC a PDF',
      description: 'Convierte fotos HEIC del iPhone en un documento PDF limpio y fácil de compartir.',
    },
    'sign-pdf': {
      name: 'Firmar PDF',
      description: 'Dibuja tu firma y colócala en cualquier punto de un documento PDF.',
    },
    'protect-pdf': {
      name: 'Proteger PDF',
  ...
  privacy: {
    ...
    tldr: {
      ...
      items: [
        ...
        'Usamos analítica respetuosa con la privacidad: solo Cloudflare Web Analytics, sin cookies y con datos agregados. No puede ver los archivos que procesas.',
    ...
    sections: [
      ...
      },
      {
        title: '3. Analítica',
        paragraphs: [
          'Usamos una única herramienta de analítica: Cloudflare Web Analytics. Nos ofrece estadísticas de tráfico agregadas y sin cookies —qué páginas son populares y de dónde proceden aproximadamente los visitantes— sin rastrear a usuarios individuales. No puede ver los archivos que abres o procesas: esos nunca salen de tu dispositivo, así que no hay nada que la analítica pueda observar.',
        ],
      },
      {
  ...
  toolUi: {
    ...
    dropDocx: 'Suelta un documento Word (.docx) aquí, o haz clic para examinar',
    dropExcel: 'Suelta un libro de Excel (.xlsx/.xls) aquí, o haz clic para examinar',
    dropHeic: 'Suelta fotos HEIC o HEIF aquí, o haz clic para examinar',
    moveUp: 'Subir',
    moveDown: 'Bajar',
    remove: 'Eliminar',
    ...
    sessionUpload: 'Datos de archivos subidos en esta sesión: {size}',
    chainNext: 'Pasos siguientes',
    errors: {
      ...
      onlyHeic: 'Solo se admiten fotos HEIC/HEIF.',
      ...
      corruptedFile:
        'No se pudo leer este archivo — puede estar dañado o en un formato que esta herramienta no admite.',
      engineDownload:
  ...
  sharedToolFaq: [
    {
      ...
      answer:
        'No. Todas las herramientas son gratuitas e ilimitadas: sin topes diarios, sin cuotas y sin registro. Tu propio dispositivo hace el trabajo, así que no hay costes de servidor que repercutir. Para mantener la estabilidad, cada herramienta tiene un generoso límite de tamaño por archivo (50–150 MB según la herramienta), muy por encima de lo que necesitan los documentos habituales.',
    },
  ],
  toolPages: {
    'merge-pdf': {
    ...
    'heic-to-pdf': {
      metaTitle: 'Convertir HEIC a PDF — Gratis, local, sin subidas | CoolPDF',
      metaDescription:
        'Convierte fotos HEIC de tu iPhone en un PDF A4 limpio, directamente en tu navegador. Sin subidas ni registro: tus fotos no salen de tu dispositivo.',
      heading: 'HEIC a PDF',
      intro:
        'Convierte hasta 20 fotos HEIC de tu iPhone en un único PDF A4. Tanto la decodificación HEIC como el ensamblado del PDF se ejecutan por completo en tu dispositivo.',
      button: 'Convertir a PDF',
      orientationLabel: 'Orientación de página',
      orientationAuto: 'Automática (según la primera foto)',
      orientationPortrait: 'Vertical',
      orientationLandscape: 'Horizontal',
      fitLabel: 'Colocación de la imagen',
      fitFit: 'Ajustar: foto completa visible, con márgenes',
      fitFill: 'Rellenar: cubre la página, recorta los bordes',
      fitOriginal: 'Original: tamaño natural, centrada',
      decodingProgress: 'Decodificando la foto {current} de {total}…',
      decodeError:
        '«{name}» no se pudo decodificar: puede que use una variante de HEIC que este decodificador no admite. Prueba a compartir la foto como JPEG desde tu iPhone.',
      stepsHeading: 'Cómo convertir fotos HEIC a PDF',
      steps: [
        'Añade hasta 20 fotos HEIC o HEIF arrastrándolas al área de carga, o haz clic para examinar.',
        'Elige la orientación de página: automática sigue la proporción de tu primera foto, o fuerza vertical u horizontal.',
        'Decide cómo se colocan las fotos (ajustadas con márgenes, rellenando la página o en tamaño original) y haz clic en «Convertir a PDF».',
        'Descarga tu PDF, con una foto por página en formato A4.',
      ],
      privacyHeading: 'Convierte fotos del iPhone sin subirlas a ningún sitio',
      privacyText:
        'Las fotos son los archivos más personales que la mayoría tenemos: familia, documentos, pizarras, recibos. Un conversor de HEIC típico te pide subir cada foto a un servidor, convertirla allí y confiar en que después la borren. CoolPDF hace todo el trabajo en tu dispositivo: una compilación en WebAssembly del decodificador libheif se ejecuta en un worker en segundo plano, dentro de la pestaña de tu navegador, convierte cada foto HEIC en un JPEG y envuelve los resultados en un PDF A4, todo en local. Tus fotos nunca tocan la red, así que no pueden registrarse, filtrarse ni acabar en un conjunto de datos. Incluso funciona sin conexión una vez cargada la página: activa el modo avión y convierte.',
      faqHeading: 'Preguntas frecuentes',
      faq: [
        {
          question: '¿Qué es HEIC y por qué convertirlo a PDF?',
          answer:
            'HEIC es el formato de foto predeterminado del iPhone desde iOS 11. Mantiene los archivos pequeños, pero muchas apps, sitios web y PC con Windows no pueden abrirlo. El PDF, en cambio, se abre en todas partes, y además reúne muchas fotos en un único documento fácil de compartir o imprimir.',
        },
        {
          question: '¿Por qué no se pudo convertir uno de mis archivos HEIC?',
          answer:
            'HEIF es un contenedor que puede albergar distintos códecs y funciones, y ningún decodificador de navegador admite todas las variantes. Las fotos tomadas con un iPhone en el formato HEVC estándar funcionan de forma fiable. Si algún archivo falla, ábrelo en tu iPhone y compártelo como JPEG (o configura Cámara → Formatos → La más compatible), y convierte ese.',
        },
        {
          question: '¿Mis fotos conservan su calidad y orientación?',
          answer:
            'Sí. Cada foto se decodifica a resolución completa y se guarda como un JPEG de alta calidad (92 % de calidad), aplicando automáticamente la rotación almacenada. Después, el PDF incrusta esas imágenes sin ninguna recompresión adicional.',
        },
      ],
    },
    'sign-pdf': {
      metaTitle: 'Firmar PDF online gratis — Dibuja y coloca firmas | CoolPDF',
      metaDescription:
        'Dibuja tu firma, colócala en cualquier parte de un PDF y descarga el documento firmado, todo en tu navegador. Sin subidas, sin registro, gratis.',
      heading: 'Firmar PDF',
      intro:
        'Dibuja tu firma con el ratón, el trackpad o el dedo, o sube una foto de ella, y colócala en cualquier página de tu PDF antes de descargar el documento firmado. Todo ocurre localmente en tu dispositivo.',
      button: 'Firmar y descargar',
      padLabel: 'Tu firma',
      padHint: 'Dibuja tu firma aquí',
      clearPad: 'Borrar',
      addToPage: 'Añadir a la página actual',
      placementHint: 'Arrastra una firma para moverla; arrastra el punto de la esquina para cambiar su tamaño.',
      ...
      drawTab: 'Dibujar',
      uploadTab: 'Subir',
      uploadChoose: 'Elegir una imagen',
      uploadChange: 'Elegir otra imagen',
      uploadHint:
        'Una foto o un escaneo de tu firma es lo que mejor funciona: tinta oscura sobre papel blanco liso. Quitamos el fondo por ti, directamente en tu navegador.',
      uploadRemoveBg: 'Quitar el fondo blanco',
      uploadStrength: 'Intensidad de la eliminación',
      uploadEmpty: 'No queda nada tras quitar el fondo: prueba a reducir la intensidad.',
      uploadError:
        'No se pudo leer esa imagen. Prueba con una foto PNG o JPG de tu firma (también funciona HEIC de un iPhone).',
      stepsHeading: 'Cómo firmar un PDF',
      steps: [
        'Añade el PDF que quieres firmar: se abre localmente, sin enviarse nunca a un servidor.',
        'Dibuja tu firma en el recuadro — o cambia a «Subir» para usar una foto de ella — y haz clic en «Añadir a la página actual».',
        'Arrastra la firma hasta el lugar correcto y ajusta su tamaño con el punto de la esquina. Cambia de página para firmar en más de un sitio.',
        'Haz clic en «Firmar y descargar» para obtener tu PDF firmado.',
      ],
      privacyHeading: 'Firma contratos sin subirlos',
      privacyText:
        'Los documentos que firmas suelen ser los más sensibles que manejas: contratos de trabajo, NDA, contratos de alquiler, facturas. La mayoría de las herramientas de firma online te obligan a subir el documento — y tu firma — a sus servidores, donde ambos esperan en colas y almacenamientos que no puedes auditar. CoolPDF funciona al revés: el documento lo renderiza tu propio navegador, y la firma que dibujas o subes tampoco sale jamás de tu dispositivo. Existe solo en la memoria de esta pestaña mientras trabajas, se estampa en el PDF en local y desaparece en el momento en que cierras la página. Sin cuenta, sin subidas y sin copia de tu firma en ningún otro lugar que no sea el documento que descargas.',
      faqHeading: 'Preguntas frecuentes',
      faq: [
        {
          question: '¿Tiene validez legal una firma dibujada?',
          answer:
            'En muchas jurisdicciones, sí para los documentos cotidianos: la ley ESIGN de EE. UU. y el reglamento eIDAS de la UE reconocen las firmas electrónicas simples para la mayoría de los contratos. Algunos documentos — testamentos, escrituras notariales, ciertos formularios oficiales — exigen formatos específicos o firmas cualificadas. En caso de duda, comprueba los requisitos de tu documento concreto.',
        },
        {
          question: '¿Puedo usar una foto de mi firma en lugar de dibujarla?',
          answer:
            'Sí. Cambia a la pestaña «Subir» y elige una foto o un escaneo de tu firma: tinta oscura sobre papel blanco liso da el resultado más limpio. El fondo blanco se elimina automáticamente, directamente en tu navegador, de modo que la firma se integra en el documento. Nada se sube a ningún sitio.',
        },
        {
          question: '¿Puedo firmar en más de un lugar?',
          answer:
            'Sí. Añade tantas firmas como necesites, en cualquier página: cada una se puede mover y redimensionar de forma independiente. Todas se estampan en un único PDF al descargar.',
        },
        {
          question: '¿Guardáis mi firma?',
          answer:
            'No. Tu dibujo existe solo en la memoria de la pestaña de tu navegador mientras trabajas, y desaparece al cerrar o recargar la página. Nunca se sube, se guarda ni se envía a ningún sitio.',
        },
      ],
    },
    'organize-pdf': {
    ...
    'docx-to-markdown': {
      metaTitle: 'Word a Markdown — Gratis y local | CoolPDF',
      metaDescription:
        'Convierte documentos .docx en Markdown limpio para notas, wikis y herramientas de IA — directamente en tu navegador. Sin subidas, sin registro.',
      heading: 'Word a Markdown',
      intro:
        'Convierte documentos .docx en Markdown limpio — títulos, listas, tablas, negrita y cursiva preservados. Perfecto para Obsidian, wikis y asistentes de IA. Todo se ejecuta en tu dispositivo.',
      button: 'Convertir a Markdown',
      stepsHeading: 'Cómo convertir Word a Markdown',
      steps: [
        'Suelta el archivo .docx en el área de carga, o haz clic para examinar.',
        'Haz clic en «Convertir a Markdown» — la conversión se ejecuta localmente en tu navegador.',
        'Descarga el archivo download.md y pégalo en tus notas, wikis o herramientas de IA.',
      ],
      privacyHeading: 'Tus documentos se quedan en tu dispositivo',
      privacyText:
        'Markdown suele ser la última parada antes de que un documento vaya a un asistente de IA o a una base de conocimiento — y son exactamente los archivos que no quieres en un servidor desconocido: informes internos, borradores de contratos, notas de reuniones. CoolPDF convierte por completo en tu navegador — sin subidas, sin cuenta y sin rastros al cerrar la pestaña.',
      faqHeading: 'Preguntas frecuentes',
      faq: [
        {
          question: '¿Qué formato se conserva?',
          answer:
            'Los títulos, listas con viñetas y numeradas, tablas, negrita, cursiva y enlaces se convierten a sus equivalentes Markdown. Los diseños complejos (cuadros de texto, columnas, imágenes flotantes) se simplifican al orden de lectura, y las imágenes incrustadas no se extraen.',
        },
        {
          question: '¿Funciona con archivos .doc?',
          answer:
            'No — solo se admite el formato moderno .docx. Abre los archivos .doc antiguos en Word o LibreOffice y guárdalos primero como .docx.',
        },
        {
          question: '¿Para qué sirve el Markdown?',
          answer:
            'Obsidian, Notion, wikis, README de GitHub, generadores de sitios estáticos, y como entrada limpia para ChatGPT, Claude y otras herramientas de IA — Markdown es el formato que mejor leen.',
        },
      ],
    },
    'xlsx-to-markdown': {
      metaTitle: 'Excel a Markdown — Gratis y local | CoolPDF',
      metaDescription:
        'Convierte libros .xlsx en tablas Markdown — una sección por hoja. Todo en tu navegador. Sin subidas, sin registro.',
      heading: 'Excel a Markdown',
      intro:
        'Convierte libros de Excel en tablas Markdown limpias — una sección por hoja, listas para docs, wikis y herramientas de IA. La conversión se ejecuta por completo en tu dispositivo.',
      button: 'Convertir a Markdown',
      stepsHeading: 'Cómo convertir Excel a Markdown',
      steps: [
        'Suelta el archivo .xlsx o .xls en el área de carga, o haz clic para examinar.',
        'Haz clic en «Convertir a Markdown» — la conversión se ejecuta localmente en tu navegador.',
        'Descarga el archivo download.md con una tabla Markdown por hoja de cálculo.',
      ],
      privacyHeading: 'Tus números se quedan en tu dispositivo',
      privacyText:
        'Las hojas de cálculo guardan los números que importan: presupuestos, nóminas, listas de clientes, modelos financieros. Convertirlas en una herramienta online cualquiera significa enviar todo eso al servidor de otro. CoolPDF lee tu libro y construye el Markdown por completo en tu navegador — nada se sube, y cerrar la pestaña borra todo rastro.',
      faqHeading: 'Preguntas frecuentes',
      faq: [
        {
          question: '¿Cómo se gestionan las hojas?',
          answer:
            'Cada hoja no vacía se convierte en una sección «## Sheet: <nombre>» con una tabla Markdown de GitHub. La primera fila no vacía se convierte en el encabezado de la tabla.',
        },
        {
          question: '¿Se convierten las fórmulas?',
          answer:
            'Las celdas se exportan con sus valores calculados tal como están guardados en el archivo, no con las fórmulas en sí.',
        },
        {
    ...
    'qr-code': {
      metaTitle: 'Generador de códigos QR gratis — Sin registro | CoolPDF',
      metaDescription:
        'Genera códigos QR para enlaces, texto, Wi-Fi y más, directamente en tu navegador. Sin subidas, sin registro y gratis para siempre. Descarga en PNG o SVG.',
      heading: 'Generador de códigos QR',
      intro:
        'Escribe o pega cualquier enlace o texto y verás aparecer el código QR mientras escribes. Se genera por completo en tu propio dispositivo: nada se envía a ningún sitio.',
      inputLabel: 'Contenido',
      inputPlaceholder: 'https://example.com — o cualquier texto…',
      sizeLabel: 'Tamaño',
      ...
      emptyHint: 'Tu código QR aparecerá aquí en cuanto empieces a escribir.',
      errorTooLong:
        'Ese contenido es demasiado largo para un solo código QR. Acórtalo o elige un nivel de corrección de errores más bajo.',
      privacyNoteInput:
        'Tu texto nunca sale de tu navegador — el código se genera localmente.',
      stepsHeading: 'Cómo crear un código QR',
      steps: [
        'Escribe o pega un enlace, un texto, credenciales Wi-Fi o cualquier otra cosa en el cuadro de contenido.',
        'El código QR aparece al instante mientras escribes: elige un tamaño y un nivel de corrección de errores si lo necesitas.',
        'Una corrección de errores más alta mantiene el código legible al imprimirlo pequeño o ligeramente dañado; una más baja permite incluir más datos.',
        'Descarga el código como una imagen PNG nítida, o como un SVG que escala a cualquier tamaño de impresión.',
      ],
      privacyHeading: 'Un generador de QR que no puede ver lo que codificas',
      privacyText:
        'La mayoría de los generadores de QR envían tu texto a un servidor y te devuelven una imagen, lo que significa que el servidor ve cada contraseña Wi-Fi, enlace privado y número de teléfono que la gente codifica. CoolPDF funciona al revés: el código del generador llega a tu navegador y tu texto nunca sale de la pestaña. Puedes abrir el panel de red mientras escribes y comprobarlo: no se envía nada. Eso lo hace seguro para credenciales, URL internas y cualquier otra cosa que prefieras guardar para ti.',
      faqHeading: 'Preguntas frecuentes',
      faq: [
        {
          question: '¿Los códigos QR caducan?',
          answer:
            'Nunca. El código es una simple imagen de tu contenido: no hay cuenta, ni servicio de redirección ni fecha de caducidad. Una vez descargado, sigue funcionando para siempre.',
        },
        {
          question: '¿Puedo usar los códigos con fines comerciales?',
          answer:
            'Sí. Todo lo que generas es tuyo: úsalo en embalajes, carteles, tarjetas de visita o trabajos para clientes, gratis y sin necesidad de atribución.',
        },
        {
          question: '¿Qué nivel de corrección de errores debo elegir?',
          answer:
            'Media (el valor predeterminado) sirve para la mayoría de los usos. Elige Alta si vas a imprimir pequeño o esperas desgaste: el código sobrevive hasta un 30 % de daño. Elige Baja para incluir más datos en un solo código.',
        },
        {
          question: '¿Mi texto se sube a algún sitio?',
          answer:
            'No. El código QR se genera por completo en tu navegador con JavaScript. Puedes desconectarte de internet después de cargar la página: sigue funcionando.',
        },
      ],
    },
    'ocr-pdf': {
      metaTitle: 'OCR PDF — Haz buscables tus PDF escaneados | CoolPDF',
      metaDescription:
        'Convierte PDF escaneados en documentos buscables y seleccionables con OCR, todo en tu navegador. Reconocimiento en inglés. Sin subidas, sin registro, gratis.',
      heading: 'OCR PDF',
      intro:
        'Añade una capa de texto real a los PDF escaneados para poder buscar, seleccionar y copiar el texto. El reconocimiento se ejecuta por completo en tu propio dispositivo: el documento nunca lo abandona.',
      button: 'OCR PDF',
      dpiLabel: 'Calidad de reconocimiento',
      dpiOptions: {
        d150: 'Rápida (150 DPI)',
        d200: 'Estándar (200 DPI)',
        d300: 'Letra pequeña (300 DPI)',
      },
      engineLoading:
        'Cargando el motor OCR — el primer uso descarga unos 7 MB y después queda en caché…',
      processingPages: 'Reconociendo página {current} de {total}…',
      downloadPdf: 'Descargar PDF buscable',
      downloadText: 'Descargar texto (.txt)',
      stepsHeading: 'Cómo aplicar OCR a un PDF',
      steps: [
        'Añade el PDF escaneado arrastrándolo al área de carga, o haz clic para examinar (hasta 100 MB).',
        'Elige una calidad de reconocimiento: Estándar (200 DPI) sirve para la mayoría de los documentos; Letra pequeña (300 DPI) ayuda con el texto reducido; Rápida (150 DPI) es la más veloz.',
        'Haz clic en «OCR PDF». El primer uso descarga el motor de reconocimiento una sola vez; después arranca al instante.',
        'Descarga el PDF buscable — las mismas páginas, ahora con una capa de texto real — o quédate solo con el texto extraído.',
      ],
      privacyHeading: 'Aplica OCR a escaneos confidenciales sin enviarlos a ningún sitio',
      privacyText:
        'Los documentos escaneados suelen ser los más sensibles: contratos firmados, historiales médicos, copias de documentos de identidad, cartas antiguas. La mayoría de los servicios OCR online te obligan a subirlos primero. CoolPDF ejecuta el motor de reconocimiento — Tesseract, compilado a WebAssembly — dentro de la pestaña de tu navegador. El documento se lee y se procesa en tu propia máquina, y ni un byte cruza la red. Puedes comprobarlo en el panel de red de tu navegador mientras trabaja. Como no hay ningún servidor haciendo el trabajo, tampoco hay cuota de páginas ni límite diario: tu dispositivo pone el único límite.',
      faqHeading: 'Preguntas frecuentes',
      faq: [
        {
          question: '¿Qué idiomas puede reconocer?',
          answer:
            'Inglés (alfabeto latino) por ahora. Otros idiomas necesitan sus propios archivos de datos de entrenamiento, que no están incluidos en esta versión: el soporte multilingüe está previsto. Los acentos y la puntuación europea habitual se manejan sin problema.',
        },
        {
          question: '¿Funciona con un PDF que ya tiene texto?',
          answer:
            'Está pensado para escaneos e imágenes sin capa de texto. Si tu PDF ya tiene texto seleccionable, no necesitas OCR: la herramienta PDF a Markdown puede extraer el texto directamente.',
        },
        {
          question: '¿Por qué tarda más el primer uso?',
          answer:
            'El primer reconocimiento descarga el motor OCR y los datos de idioma (unos 7 MB). Ambos quedan en caché en tu dispositivo, así que los usos siguientes arrancan al instante, incluso sin conexión.',
        },
        {
          question: '¿Mis documentos se suben para el OCR?',
          answer:
            'No. El reconocimiento se ejecuta por completo en tu navegador, en tu propio procesador. No se envía nada a ningún servidor: el contador de datos subidos de arriba se queda en cero mientras trabaja.',
        },
      ],
    },
  },
