export const pt = {
  ...
  home: {
    ...
    toolsSection: {
      ...
      subheading:
        '{count} ferramentas essenciais de PDF, cada uma a funcionar inteiramente no seu próprio dispositivo.',
    },
    why: {
  ...
  tools: {
    'ocr-pdf': {
      name: 'OCR PDF',
      description: 'Torne os PDFs digitalizados pesquisáveis com OCR, no seu dispositivo.',
    },
    'qr-code': {
      name: 'Gerador de códigos QR',
      description: 'Crie códigos QR para links, textos e mais — gerados localmente.',
    },
    'merge-pdf': {
      name: 'Juntar PDF',
    ...
    'extract-images': {
      ...
      description: 'Retire todas as imagens incorporadas de um PDF.',
    },
    'pdf-to-jpg': {
      name: 'PDF para JPG',
    ...
    'heic-to-pdf': {
      name: 'HEIC para PDF',
      description: 'Converta fotos HEIC do seu iPhone num documento PDF limpo e fácil de partilhar.',
    },
    'sign-pdf': {
      name: 'Assinar PDF',
      description: 'Desenhe a sua assinatura e coloque-a em qualquer ponto de um documento PDF.',
    },
    'protect-pdf': {
      name: 'Proteger PDF',
  ...
  privacy: {
    ...
    tldr: {
      ...
      items: [
        ...
        'Utilizamos análises respeitadoras da privacidade: apenas o Cloudflare Web Analytics, sem cookies e com dados agregados. Não consegue ver os ficheiros que processa.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Utilizamos uma única ferramenta de análise: o Cloudflare Web Analytics. Dá-nos estatísticas de tráfego agregadas e sem cookies — que páginas são populares e, aproximadamente, de onde vêm os visitantes — sem rastrear indivíduos. Não consegue ver os ficheiros que abre ou processa: esses nunca saem do seu dispositivo, pelo que não há nada que as análises possam observar.',
        ],
      },
      {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "O CoolPDF oferece 18 ferramentas para juntar, dividir, comprimir, rodar e organizar páginas, converter imagens, proteger e desbloquear, adicionar marcas de água e números de página, converter para Markdown (PDF, Word, Excel) e extrair imagens. Todas funcionam localmente no seu navegador.",
      },
    ],
  },
  factSummary:
  ...
  toolUi: {
    ...
    dropHeic: 'Largue fotos HEIC ou HEIF aqui, ou clique para procurar',
    ...
    errors: {
      ...
      onlyHeic: 'Apenas fotos HEIC/HEIF são suportadas.',
      noImages: 'Não foram encontradas imagens incorporadas neste PDF.',
  ...
  toolPages: {
    ...
    'heic-to-pdf': {
      metaTitle: 'Converter HEIC para PDF — Grátis e local | CoolPDF',
      metaDescription:
        'Converta fotos HEIC do seu iPhone num PDF A4 limpo diretamente no seu navegador. Sem carregamentos nem registo — as suas fotos nunca saem do dispositivo.',
      heading: 'HEIC para PDF',
      intro:
        'Converta até 20 fotos HEIC do seu iPhone num único PDF A4. A descodificação HEIC e a montagem do PDF são executadas inteiramente no seu dispositivo.',
      button: 'Converter para PDF',
      orientationLabel: 'Orientação da página',
      orientationAuto: 'Automática (segue a primeira foto)',
      orientationPortrait: 'Retrato',
      orientationLandscape: 'Paisagem',
      fitLabel: 'Posicionamento da imagem',
      fitFit: 'Ajustar — foto inteira visível, com margens',
      fitFill: 'Preencher — cobre a página, corta as margens',
      fitOriginal: 'Original — tamanho natural, centrada',
      decodingProgress: 'A descodificar a foto {current} de {total}…',
      decodeError:
        'Não foi possível descodificar “{name}” — pode usar uma variante de HEIC que este descodificador não suporta. Experimente partilhar a foto como JPEG a partir do seu iPhone.',
      stepsHeading: 'Como converter fotos HEIC para PDF',
      steps: [
        'Adicione até 20 fotos HEIC ou HEIF arrastando-as para a área de carregamento, ou clique para procurar.',
        'Escolha a orientação da página: automática segue a proporção da sua primeira foto, ou force retrato ou paisagem.',
        'Decida como as fotos são posicionadas — ajustadas com margens, a preencher a página ou em tamanho original — e clique em “Converter para PDF”.',
        'Descarregue o seu PDF, com uma foto por página em formato A4.',
      ],
      privacyHeading: 'Converta fotos do iPhone sem carregar um único píxel',
      privacyText:
        'As fotos são os ficheiros mais pessoais que a maioria de nós tem — família, documentos, quadros brancos, recibos. Um conversor de HEIC típico pede-lhe que carregue cada foto para um servidor, converta-a lá e confie que será eliminada depois. O CoolPDF faz todo o trabalho no seu dispositivo: uma versão WebAssembly do descodificador libheif corre num worker em segundo plano, diretamente no separador do seu navegador, transforma cada foto HEIC num JPEG e reúne os resultados num PDF A4 — tudo localmente. As suas fotos nunca tocam na rede, por isso não podem ser registadas, vazar ou acabar num conjunto de dados. Funciona até offline depois de a página carregar: ative o modo de avião e converta à vontade.',
      faqHeading: 'Perguntas frequentes',
      faq: [
        {
          question: 'O que é HEIC, e porque convertê-lo para PDF?',
          answer:
            'HEIC é o formato de fotografia predefinido nos iPhones desde o iOS 11. Mantém os ficheiros pequenos, mas muitas aplicações, sites e PCs com Windows não o conseguem abrir. O PDF, por outro lado, abre em todo o lado — e junta muitas fotos num único documento fácil de partilhar ou imprimir.',
        },
        {
          question: 'Porque é que um dos meus ficheiros HEIC não foi convertido?',
          answer:
            'HEIF é um contentor que pode albergar diferentes codecs e funcionalidades, e nenhum descodificador de navegador suporta todas as variantes. As fotos tiradas num iPhone no formato HEVC padrão funcionam de forma fiável. Se um ficheiro falhar, abra-o no seu iPhone e partilhe-o como JPEG (ou defina Câmara → Formatos → Mais compatível) e depois converta esse.',
        },
        {
          question: 'As minhas fotos mantêm a qualidade e a orientação?',
          answer:
            'Sim. Cada foto é descodificada em resolução total e gravada como JPEG de alta qualidade (92% de qualidade), com a rotação guardada aplicada automaticamente. O PDF incorpora depois essas imagens sem qualquer recompressão adicional.',
        },
      ],
    },
    'sign-pdf': {
      metaTitle: 'Assinar PDF online grátis — desenhe a assinatura | CoolPDF',
      metaDescription:
        'Desenhe a sua assinatura, coloque-a em qualquer ponto de um PDF e descarregue o documento assinado — tudo no seu navegador. Sem carregamentos nem registo.',
      heading: 'Assinar PDF',
      intro:
        'Desenhe a sua assinatura com o rato, o trackpad ou o dedo — ou carregue uma foto dela — e coloque-a em qualquer página do seu PDF; depois descarregue o documento assinado. Tudo acontece localmente no seu dispositivo.',
      button: 'Assinar e descarregar',
      padLabel: 'A sua assinatura',
      padHint: 'Desenhe a sua assinatura aqui',
      clearPad: 'Limpar',
      addToPage: 'Adicionar à página atual',
      placementHint: 'Arraste uma assinatura para a mover — arraste o ponto no canto para a redimensionar.',
      pageIndicator: 'Página {current} de {total}',
      prevPage: 'Página anterior',
      nextPage: 'Página seguinte',
      stampLabel: 'Assinatura',
      drawTab: 'Desenhar',
      uploadTab: 'Carregar',
      uploadChoose: 'Escolher uma imagem',
      uploadChange: 'Escolher outra imagem',
      uploadHint:
        'Uma foto ou digitalização da sua assinatura funciona melhor — tinta escura em papel branco liso. Removemos o fundo por si, diretamente no seu navegador.',
      uploadRemoveBg: 'Remover o fundo branco',
      uploadStrength: 'Intensidade da remoção',
      uploadEmpty: 'Não sobrou nada depois da remoção do fundo — experimente reduzir a intensidade.',
      uploadError:
        'Não foi possível ler essa imagem. Experimente uma foto PNG ou JPG da sua assinatura (HEIC de um iPhone também funciona).',
      stepsHeading: 'Como assinar um PDF',
      steps: [
        'Adicione o PDF que quer assinar — é aberto localmente, nunca enviado para um servidor.',
        'Desenhe a sua assinatura no painel — ou mude para o separador “Carregar” para usar uma foto dela — e clique em “Adicionar à página atual”.',
        'Arraste a assinatura para o local certo e redimensione-a com o ponto no canto. Mude de página para assinar em mais do que um lugar.',
        'Clique em “Assinar e descarregar” para obter o seu PDF assinado.',
      ],
      privacyHeading: 'Assine contratos sem os carregar',
      privacyText:
        'Os documentos que assina são geralmente os mais sensíveis que trata: contratos de trabalho, NDAs, contratos de arrendamento, faturas. A maioria das ferramentas de assinatura online obriga-o a carregar o documento — e a sua assinatura — para os servidores delas, onde ambos ficam em filas e armazenamento que não pode auditar. O CoolPDF inverte o fluxo: o documento é renderizado pelo seu próprio navegador e a assinatura que desenha ou carrega também nunca sai do seu dispositivo. Existe apenas na memória deste separador enquanto trabalha, é estampada no PDF localmente e desaparece no momento em que fecha a página. Sem conta, sem carregamentos, sem cópia da sua assinatura em lado nenhum além do documento que descarrega.',
      faqHeading: 'Perguntas frequentes',
      faq: [
        {
          question: 'Uma assinatura desenhada é legalmente válida?',
          answer:
            'Em muitas jurisdições, sim para documentos do dia a dia: a lei ESIGN dos EUA e o regulamento eIDAS da UE reconhecem assinaturas eletrónicas simples para a maioria dos contratos. Alguns documentos — testamentos, escrituras notariais, certos formulários governamentais — exigem formatos específicos ou assinaturas qualificadas. Em caso de dúvida, confirme os requisitos do seu documento em concreto.',
        },
        {
          question: 'Posso usar uma foto da minha assinatura em vez de a desenhar?',
          answer:
            'Sim. Mude para o separador “Carregar” e escolha uma foto ou digitalização da sua assinatura — tinta escura em papel branco liso dá o resultado mais limpo. O fundo branco é removido automaticamente, diretamente no seu navegador, para que a assinatura se funda no documento. Nada é carregado para lado nenhum.',
        },
        {
          question: 'Posso assinar em mais do que um lugar?',
          answer:
            'Sim. Adicione quantas assinaturas precisar, em qualquer página — cada uma pode ser movida e redimensionada de forma independente. São todas estampadas num único PDF quando descarrega.',
        },
        {
          question: 'Guardam a minha assinatura?',
          answer:
            'Não. O seu desenho existe apenas na memória do separador do navegador enquanto trabalha e desaparece quando fecha ou atualiza a página. Nunca é carregado, guardado nem enviado para lado nenhum.',
        },
      ],
    },
    'organize-pdf': {
    ...
    'extract-images': {
      metaTitle: 'Extrair imagens de um PDF grátis online | CoolPDF',
      metaDescription:
        'Retire todas as imagens incorporadas de um PDF — fotos, digitalizações, logótipos — como ficheiros JPG/PNG. 100% no seu navegador, sem carregamentos, sem registo.',
      heading: 'Extrair imagens de um PDF',
      intro:
        'Retire fotos, digitalizações e logótipos de qualquer PDF e guarde-os como ficheiros JPG ou PNG individuais — píxeis originais, sem recompressão. Tudo é executado localmente no seu navegador.',
      button: 'Extrair imagens',
      scopeLabel: 'Páginas',
      scopeAll: 'Todas as páginas',
      scopeCustom: 'Páginas selecionadas',
      pagesLabel: 'Páginas',
      pagesPlaceholder: 'ex. 1-3, 5',
      progressFound: '{count} imagens encontradas…',
      stepsHeading: 'Como extrair imagens de um PDF',
      steps: [
        'Adicione o PDF arrastando-o para a área de carregamento, ou clique para procurar.',
        'Opcionalmente, limite a extração a páginas específicas (ex. 1-3, 5).',
        'Clique em «Extrair imagens» — as imagens incorporadas são extraídas uma a uma, na qualidade original.',
        'Descarregue o resultado: uma única imagem diretamente, ou tudo em images.zip.',
      ],
      privacyHeading: 'As fotos dentro dos seus documentos continuam privadas',
      privacyText:
        'As imagens dentro dos PDFs são muitas vezes a parte mais sensível: digitalizações de passaportes, fotos de imóveis, imagens de produto sob NDA. O CoolPDF descompacta-as inteiramente no seu navegador — o ficheiro é lido do seu próprio disco e as imagens são guardadas de volta nele, sem nada ser carregado entretanto.',
      faqHeading: 'Perguntas frequentes',
      faq: [
        {
          question: 'As imagens têm qualidade original?',
          answer:
            'São exatamente as imagens incorporadas. As que têm transparência são guardadas como PNG, as restantes como JPEG de alta qualidade (92%). A extração nunca reduz nem recomprime abaixo do original.',
        },
        {
          question: 'Por que obtive menos imagens do que esperava?',
          answer:
            'O extrator retira imagens raster incorporadas. Gráficos e diagramas desenhados como vetores não são imagens raster e não estão incluídos — use PDF para JPG para renderizar essas páginas como imagens.',
        },
        {
          question: 'Quais são os limites?',
          answer: 'Ficheiros até 100 MB (50 MB em dispositivos móveis), até 200 imagens por documento.',
        },
      ],
    },
    'pdf-to-jpg': {
    ...
    'qr-code': {
      metaTitle: 'Gerador de códigos QR grátis — Local, sem registo | CoolPDF',
      metaDescription:
        'Crie códigos QR para links, texto, Wi-Fi e mais — no seu navegador. Sem carregamentos, sem registo, grátis para sempre. Descarregue como PNG ou SVG.',
      heading: 'Gerador de códigos QR',
      intro:
        'Escreva ou cole qualquer link ou texto e veja o código QR aparecer enquanto escreve. É gerado inteiramente no seu próprio dispositivo — nada é enviado para lado nenhum.',
      inputLabel: 'Conteúdo',
      inputPlaceholder: 'https://example.com — ou qualquer texto…',
      sizeLabel: 'Tamanho',
      levelLabel: 'Correção de erros',
      levels: {
        l: 'Baixa (7%)',
        m: 'Média (15%)',
        q: 'Quartil (25%)',
      ...
      emptyHint: 'O seu código QR aparecerá aqui assim que começar a escrever.',
      errorTooLong:
        'Esse conteúdo é demasiado longo para um único código QR. Encurte-o ou escolha um nível de correção de erros mais baixo.',
      privacyNoteInput:
        'O seu texto nunca sai do seu navegador — o código é gerado localmente.',
      stepsHeading: 'Como criar um código QR',
      steps: [
        'Escreva ou cole um link, um texto, credenciais de Wi-Fi ou qualquer outra coisa na caixa de conteúdo.',
        'O código QR aparece instantaneamente enquanto escreve — escolha um tamanho e um nível de correção de erros, se precisar.',
        'Uma correção de erros mais alta mantém o código legível quando impresso pequeno ou ligeiramente danificado; uma correção mais baixa permite incluir mais dados.',
        'Descarregue o código como uma imagem PNG nítida ou como um SVG que escala para qualquer tamanho de impressão.',
      ],
      privacyHeading: 'Um gerador de QR que não consegue ver o que codifica',
      privacyText:
        'A maioria dos geradores de QR envia o seu texto para um servidor e devolve-lhe uma imagem — o que significa que o servidor vê cada palavra-passe de Wi-Fi, link privado e número de telefone que as pessoas codificam. O CoolPDF funciona ao contrário: o código do gerador vem para o seu navegador e o seu texto nunca sai do separador. Pode abrir o painel de rede enquanto escreve e observar — nada é enviado. Isto torna-o seguro para credenciais, URLs internos e tudo o mais que preferir manter consigo.',
      faqHeading: 'Perguntas frequentes',
      faq: [
        {
          question: 'Os códigos QR expiram?',
          answer:
            'Nunca. O código é uma imagem simples do seu conteúdo — não há conta, serviço de redirecionamento nem data de validade. Depois de descarregado, continua a funcionar para sempre.',
        },
        {
          question: 'Posso usar os códigos comercialmente?',
          answer:
            'Sim. Tudo o que gera é seu — use-o em embalagens, cartazes, cartões de visita ou trabalhos para clientes, gratuitamente e sem necessidade de atribuição.',
        },
        {
          question: 'Que nível de correção de erros devo escolher?',
          answer:
            'Média (a predefinição) serve para a maioria dos casos. Escolha Alta para impressões pequenas ou sujeitas a desgaste — o código sobrevive a até 30% de danos. Escolha Baixa para incluir mais dados num só código.',
        },
        {
          question: 'O meu texto é carregado para algum lado?',
          answer:
            'Não. O código QR é gerado inteiramente no seu navegador com JavaScript. Pode desligar-se da internet depois de a página carregar — continua a funcionar.',
        },
      ],
    },
    'ocr-pdf': {
      metaTitle: 'OCR PDF grátis — Digitalizações pesquisáveis | CoolPDF',
      metaDescription:
        'Torne PDFs digitalizados pesquisáveis e selecionáveis com OCR — inteiramente no seu navegador. Reconhecimento de inglês. Sem carregamentos, sem registo, grátis.',
      heading: 'OCR PDF',
      intro:
      ...
      button: 'OCR PDF',
      dpiLabel: 'Qualidade de reconhecimento',
      dpiOptions: {
        d150: 'Rápida (150 DPI)',
        d200: 'Padrão (200 DPI)',
        d300: 'Letra pequena (300 DPI)',
      },
      engineLoading:
        'A carregar o motor de OCR — a primeira execução descarrega cerca de 7 MB e fica em cache depois…',
      processingPages: 'A reconhecer a página {current} de {total}…',
      downloadPdf: 'Descarregar PDF pesquisável',
      downloadText: 'Descarregar texto (.txt)',
      stepsHeading: 'Como aplicar OCR a um PDF',
      steps: [
        'Adicione o PDF digitalizado arrastando-o para a área de carregamento, ou clique para procurar (até 100 MB).',
        'Escolha uma qualidade de reconhecimento: Padrão (200 DPI) serve para a maioria dos documentos; Letra pequena (300 DPI) ajuda com texto pequeno; Rápida (150 DPI) é a mais veloz.',
        'Clique em “OCR PDF”. A primeira execução descarrega o motor de reconhecimento uma única vez; depois disso, arranca instantaneamente.',
        'Descarregue o PDF pesquisável — as mesmas páginas, agora com uma camada de texto real — ou obtenha apenas o texto extraído.',
      ],
      privacyHeading: 'OCR a digitalizações confidenciais sem as enviar para lado nenhum',
      privacyText:
      ...
      faq: [
        {
          question: 'Que idiomas consegue reconhecer?',
          answer:
        ...
        {
          question: 'Funciona num PDF que já tem texto?',
          answer:
        ...
        {
          question: 'Porque é que a primeira execução demora mais?',
          answer:
        ...
        {
          question: 'Os meus documentos são carregados para o OCR?',
          answer:
