export const fr = {
  ...
  tools: {
    ...
    'sign-pdf': {
      name: 'Signer un PDF',
      description: 'Dessinez votre signature et placez-la où vous voulez sur un document PDF.',
    },
    'protect-pdf': {
      name: 'Protéger PDF',
  ...
  sharedToolFaq: [
    {
      ...
      answer:
        'Non. Tous les outils sont gratuits et illimités — aucun plafond quotidien, aucun quota, aucune inscription. C’est votre appareil qui fait le travail, il n’y a donc aucun coût de serveur à répercuter. Pour garantir la stabilité, chaque outil applique une généreuse limite de taille par fichier (50 à 150 Mo selon l’outil), bien au-delà des besoins du quotidien.',
    },
  ],
  toolPages: {
    'merge-pdf': {
    ...
    'sign-pdf': {
      metaTitle: 'Signer un PDF en ligne gratuit | CoolPDF',
      metaDescription:
        'Dessinez votre signature, placez-la sur le PDF et téléchargez le document signé — le tout dans votre navigateur. Aucun téléversement, aucune inscription.',
      heading: 'Signer un PDF',
      intro:
        'Dessinez votre signature à la souris, au pavé tactile ou au doigt — ou téléversez-en une photo — puis placez-la sur la page de votre choix et téléchargez le document signé. Tout se passe localement sur votre appareil.',
      button: 'Signer et télécharger',
      padLabel: 'Votre signature',
      padHint: 'Dessinez votre signature ici',
      clearPad: 'Effacer',
      addToPage: 'Ajouter à la page actuelle',
      placementHint: 'Faites glisser une signature pour la déplacer — faites glisser le point d’angle pour la redimensionner.',
      ...
      uploadChoose: 'Choisir une image',
      uploadChange: 'Choisir une autre image',
      uploadHint:
        'Une photo ou un scan de votre signature donne le meilleur résultat — encre foncée sur papier blanc uni. Nous supprimons le fond pour vous, directement dans votre navigateur.',
      uploadRemoveBg: 'Supprimer le fond blanc',
      uploadStrength: 'Intensité de la suppression',
      uploadEmpty: 'Il ne reste rien après la suppression du fond — essayez de réduire l’intensité.',
      uploadError:
        'Impossible de lire cette image. Essayez une photo PNG ou JPG de votre signature (le HEIC d’un iPhone fonctionne aussi).',
      stepsHeading: 'Comment signer un PDF',
      steps: [
        'Téléversez le PDF que vous souhaitez signer — il est ouvert localement, jamais envoyé à un serveur.',
        'Dessinez votre signature dans la zone de signature — ou passez à l’onglet « Téléverser » pour utiliser une photo — puis cliquez sur « Ajouter à la page actuelle ».',
        'Faites glisser la signature au bon endroit et redimensionnez-la à l’aide du point d’angle. Changez de page pour signer à plusieurs endroits.',
        'Cliquez sur « Signer et télécharger » pour obtenir votre PDF signé.',
      ],
      privacyHeading: 'Signez vos contrats sans les téléverser',
      privacyText:
        'Les documents que vous signez sont généralement les plus sensibles que vous manipuliez : contrats de travail, NDA, contrats de location, factures. La plupart des outils de signature en ligne vous demandent de téléverser le document — et votre signature — sur leurs serveurs, où l’un et l’autre séjournent dans des files d’attente et des stockages que vous ne pouvez pas auditer. CoolPDF inverse ce schéma : le document est affiché par votre propre navigateur, et la signature que vous dessinez ou téléversez ne quitte pas non plus votre appareil. Elle n’existe que dans la mémoire de cet onglet pendant que vous travaillez, elle est apposée localement dans le PDF, puis elle disparaît dès que vous fermez la page. Aucun compte, aucun téléversement, aucune copie de votre signature ailleurs que dans le document que vous téléchargez.',
      faqHeading: 'Questions fréquentes',
      faq: [
        {
          question: 'Une signature dessinée est-elle juridiquement valable ?',
          answer:
            'Dans de nombreuses juridictions, oui pour les documents du quotidien : la loi américaine ESIGN et le règlement européen eIDAS reconnaissent les signatures électroniques simples pour la plupart des contrats. Certains documents — testaments, actes notariés, certains formulaires administratifs — exigent des formats spécifiques ou des signatures qualifiées. En cas de doute, vérifiez les exigences propres à votre document.',
        },
        {
          question: 'Puis-je utiliser une photo de ma signature au lieu de la dessiner ?',
          answer:
            'Oui. Passez à l’onglet « Téléverser » et choisissez une photo ou un scan de votre signature — une encre foncée sur papier blanc uni donne le résultat le plus net. Le fond blanc est supprimé automatiquement, directement dans votre navigateur, pour que la signature se fonde dans le document. Rien n’est téléversé nulle part.',
        },
        {
          question: 'Puis-je signer à plusieurs endroits ?',
          answer:
            'Oui. Ajoutez autant de signatures que nécessaire, sur n’importe quelle page — chacune peut être déplacée et redimensionnée indépendamment. Elles sont toutes apposées dans un seul PDF au moment du téléchargement.',
        },
        {
          question: 'Conservez-vous ma signature ?',
          answer:
            'Non. Votre dessin n’existe que dans la mémoire de l’onglet de votre navigateur pendant que vous travaillez, et il disparaît dès que vous fermez ou actualisez la page. Il n’est jamais téléversé, enregistré ni envoyé où que ce soit.',
        },
      ],
    },
    'organize-pdf': {
