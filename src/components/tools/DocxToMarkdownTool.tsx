...
import { docxToMarkdown } from '@/lib/office/docx-to-markdown';
...
interface DocxToMarkdownToolProps {
  dict: Dictionary;
}
...
export function DocxToMarkdownTool({ dict }: DocxToMarkdownToolProps) {
  const ui = dict.toolUi;
  const copy = dict.toolPages['docx-to-markdown'];
