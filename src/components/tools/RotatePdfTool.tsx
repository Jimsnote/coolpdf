...
export function RotatePdfTool({ dict }: RotatePdfToolProps) {
  const ui = dict.toolUi;
  const copy = dict.toolPages['rotate-pdf'];
    ...
    <ToolShell
      ...
      options={
        <div className="space-y-4">
          <fieldset>
            <legend className="text-sm font-semibold text-slate-900">{copy.angleLabel}</legend>
